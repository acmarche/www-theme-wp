...
function Category( props ) {
    ...
    function changeActive( temp_e ) {
        ...
        console.log( eventDataAttribute );
        props.setCategories( ( previousCategories ) => previousCategories.map( ( object ) => {
